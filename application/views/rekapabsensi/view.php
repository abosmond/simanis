...
$(function(){
	...
	$('#formKlien').submit(function() {
		$.ajax({
			type	: 'POST',
			url		: '<?=base_url()?>rekapabsensi/lists',
			data	: $(this).serialize(),
...
<table width="100%" class="table-form">	
	<tr>
        <td>Periode </td>
        <td><input type="text" name="tglawal" id="popupDatepicker" size="20" value="" />&nbsp;&nbsp;&nbsp;&nbsp;Sampai&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="tglakhir" id="akhirDatepicker" size="20" value="" /></td>
    </tr>
	<tr>
        <td>NIS </td>
