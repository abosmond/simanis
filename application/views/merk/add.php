...
$(document).ready(function(){
  ...
  $('#btn_simpan').click(function(){
    ...
    if ($_type == 'add') {
      ...
      $.post(
        $_base_url + 'index.php/master/barang/update_barang_ajax',
        ...
        function(data) {
          if (data.result == 'false') {
            ...
            window.location = $_base_url + 'index.php/master/barang';
          }
        },
        'json'
      );
...
<p>
Kode <br/>
<input type="text" name="kode" id="kode" size="10" maxlength="10"/>
</p>

<p>
Merk <br/>
<input type="text" name="merk" id="merk" size="50" maxlength="50"/>
</p>
