			...
			<div id="content">
				<div id="sidebar">
					...
					<div class="sidebarContents">
						...
						<li>
							<a href="javascript: return void(0)"><strong>SETTING AKADEMIK & SISWA</strong></a>
							<ul>
								<li>
								...
								<li>
									<a href="<?=base_url();?>settingulangan">Setting Ulangan</a>
								</li>	
								<li>
						...
						<li>
							<a href="javascript: return void(0)"><strong>SETTING SMS</strong></a>
							<ul>
								<li>
						...
						<li>
							<a href="javascript: return void(0)"><b>DATA POKOK</b></a>
							<ul>
								<li>
						...
						<li>
							...
							<a href="javascript: return void(0)"><b>DATA SISWA & AKTIFITAS</b></a>
							<ul>
								<li>
						...
						<li>
							<a href="javascript: return void(0)"><b>LAPORAN</b></a>
							<ul>
								<li>
									<a href="<?=base_url();?>rekapabsensi">Rekap Absensi</a>
								</li>
								<li>
									<a href="<?=base_url();?>rekapspp">Rekap SPP</a>
								</li>
							</ul>
						</li>
					</ul>					
